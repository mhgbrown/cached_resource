# CachedResource ![Tests](https://github.com/mhgbrown/cached_resource/actions/workflows/ruby.yml/badge.svg) ![SVG](https://dev.w3.org/SVG/tools/svgweb/samples/svg-files/acid.svg)
